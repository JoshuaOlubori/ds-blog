...
tags: ["python"]
draft: false
summary: "Interacting with users"
layout: PostSimple
...
The execution of this program could look like this (input from the user in **bold**):
...
### 🛠️ Exercise 2.2: Name and Exclamation Marks
...
[👉 Solve this in the Notebook](../python_01.ipynb)[Click here to open the Exercise in Google Colab](https://colab.research.google.com/github/JoshuaOlubori/data-science-course/blob/main/Python/01/python_01.ipynb)
...
### 🛠️ Exercise 2.3: Name and Address
...
### 🛠️ Exercise 2.4: Fix the Code - Utterances
...
However, there is something wrong with the code. Please fix it.

[Click here to open the Exercise in Google Colab](https://colab.research.google.com/github/JoshuaOlubori/data-science-course/blob/main/Python/01/python_01.ipynb)

### 🛠️ Exercise 2.5: Story
...
[⬅️ Previous: Getting Started](01-getting-started.md) | [Next: More About Variables ➡️](03-more-about-variables.md)
