...
The reason this part is excluded is because, this online service does not allow you to create a database unless we buy a subscription. So instead, we are creating tables inside the default database.
